...
class usrp_sdrbasics(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Basics of SDRs and IQ", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Basics of SDRs and IQ")
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_sdrbasics")
        ...
        # Connections
        ##################################################
        self.connect((self.uhd_usrp_source_1, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        self.connect((self.uhd_usrp_source_1, 0), (self.qtgui_time_sink_x_0_0_0, 0))
...
def main(top_block_cls=usrp_sdrbasics, options=None):
